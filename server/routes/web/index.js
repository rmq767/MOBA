module.exports = app => {
  ...
  router.get("/news/init", async (req, res) => {
    ...
    const newsTitles = [
      ...
      "新星元套装爆料丨大小姐驾到！未来机甲高能预警~",
      "过年有王者！新春相约峡谷，与你开启福气年",
      "2月4日全服不停机更新公告",
      "",
      "2月1日全服不停机更新公告",
      "净化游戏环境声明及处罚公告",
      ...
      "金鼠送礼 峡谷新春福利来袭",
      "组队消费活动消费期开启说明",
      "【蔷薇的历练之年兽大作战】活动公告及FAQ",
      "内测皮肤获取方式升级【蔷薇的历练】开启",
      "凤求凰&amp;凤凰于飞限时返场 皮肤优化即将来袭",
      "中国电竞小伙逐梦记",
      "中国电竞小伙逐梦记",
      ...
      "假期狂欢季线上赏金对抗赛即将开启，这次由你当“教练”！",
      "历时72小时打造东北版《王者荣耀》，雪雕王者经典形象",
      "KPL",
      "2020年KPL新春贺岁短片《赢家》倒计时2天！",
      "又是一年春节到！各位召唤师们是不是已经开始期待过年了呢？每逢春节，KPL一年一度的新春贺岁短篇也将来袭——2020年贺岁短篇《赢家》将在2天后，也就是大年初一（1月25日）上映！",
      "KPL",
      "2020KPL春季赛大名单公示",
      "KPL",
      "年度巡礼——TS特例独行稳步向前",
      ...
      "年度巡礼——2019年XQ的重生",
      "KPL",
      "再见选手AT，LGD大鹅官宣AT加入教练组",
      "KPL",
      "2020年KPL新春贺岁短片《赢家》来袭，粉丝见面会1月18日南京开启",
      "KPL",
      "年度巡礼——2019打醉拳的RW侠"
    ];
    ...
    await Article.deleteMany({}); //以任意条件去查询删除
    await Article.insertMany(newsList); //插入数据库
    res.send(newsList);
  });
